...
(defparameter *jungle* '(45 10 10 10)) ;first 2 numbers are the xy coords. of the jungle, next 2 are its size
(defparameter *plant-energy* 80)
(defparameter *plants* (make-hash-table :test #'equal))
(defparameter *reproduction-energy* 200)

(defun random-plant (left top width height)
  "Random plant within an specified region"
  (let ((pos (cons (+ left (random width))
		   (+ top  (random height)))))
    (setf (gethash pos *plants*) t)))

(defun add-plants ()
  "Adds a plant in the whole world and another in the jungle."

...
;; This will loop forever if there are no empty nodes. This should be fixed.
...
(defun draw-city (fname)
  (ugraph->png fname *congestion-city-nodes* *congestion-city-edges*))
...
(defun draw-known-city ()
  (ugraph->png "~/city.dot" (known-city-nodes) (known-city-edges)))
